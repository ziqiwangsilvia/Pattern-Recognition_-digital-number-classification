function [ siftfeatures ] = extractSiftFeatures( m )
%EXTRACTSIFTFEATURES Summary of this function goes here
%   Detailed explanation goes here
    row=32;
    colum=32;
    img=m;
    img=imresize(img,[row,colum]);
    %img=rgb2gray(img);% img=histeq(img);
    img=im2double(img);
    origin=img;% img=medfilt2(img);
